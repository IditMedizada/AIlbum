...
class PhotoDisplayPageState extends State<PhotoDisplayPage> {
  ...
  // Load all photos from Firebase Storage for the specified album
  Future <void> loadPhotos() async {
    try {
        // Get the reference to the album directory in Firebase Storage
  ...
  // Download all photos to the user's phone
  ...
  // Refresh the phone's media gallery to recognize new photos
